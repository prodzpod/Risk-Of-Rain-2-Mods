...
namespace PassiveAgression.Mage
{
    public static class BloodPrimary
    {
        ...
        static BloodPrimary()
        {
            ...
            proPrefab.GetComponent<ProjectileDamage>().damageType = new()
            {
            ...
            */
            ...
            IL.EntityStates.Mage.Weapon.FireFireBolt.FireGauntlet += (il) =>
            {
                ...
                {
                    if (self is BloodPrimaryState) return new DamageTypeCombo(DamageType.BleedOnHit, DamageTypeExtended.Generic, DamageSource.Primary);
                    return combo;
                });
            };
        }
