...
namespace PassiveAgression.ModCompat
{
    public class DriverStarSeed : RobDriver.Modules.Weapons.BaseWeapon<DriverStarSeed>
    {
        ...
        public override string weaponDescToken => "A star in the palm of your hands.";
        ...
        public class DriverStarShineState : BaseDriverSkillState
        {
            ...
            {
                base.OnEnter();
                PlayAnimation("Gesture, Override", "PressVoidButton", "Action.playbackRate", iDrive.AmmoPercent * 20f);
